...
env_path = os.path.join(os.getenv("CI_PROJECT_DIR", "."), ".env")
print(f"Loading .env from: {env_path}")  # 경로 디버깅용 출력
...
app = Flask(
    __name__,
    template_folder="./ui/templates",  # HTML 템플릿 경로
    static_folder="./ui/static"        # 정적 파일 경로
)
